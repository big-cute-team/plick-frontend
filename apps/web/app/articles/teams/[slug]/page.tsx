...
/**
 * 팀별 기사 목록 메타데이터 (KAN-350). canonical은 자기 자신이 아니라 팀
 * 허브(`/teams/[slug]`)다 — 둘 다 같은 팀의 기사 목록이라 중복 콘텐츠로 시그널이
 * 갈리는 걸 막고, 팀 검색어의 랜딩은 팀 허브 하나로 모은다(SEO 전략 Step 2-2).
 * 이 URL은 새로고침·공유가 기사 surface에 남게 하는 UX 몫이다.
 */
...
/**
 * 팀별 기사 목록 (KAN-350) — 기사 페이지에서 고른 팀 탭이 URL로 남는 라우트.
