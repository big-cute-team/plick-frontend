import type { MatchEvent } from "@plick/domain/live";

/**
 * 상세 좌측의 득점 카드(피그마 LW4) — 골만 추려 홈은 왼쪽, 어웨이는 오른쪽
 * 정렬로 그린다. 골이 없으면 카드를 그리지 않는다.
 */
export function GoalsCard({ events }: { events: MatchEvent[] }) {
