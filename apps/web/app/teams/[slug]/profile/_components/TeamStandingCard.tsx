...
export function TeamStandingCard({ row }: { row: StandingRow }) {
  return (
    <Link
      href="/live"
      className="bg-elevate rounded-control hover:bg-elevate-2 focus-visible:outline-accent flex w-fit items-center gap-5 px-5 py-3.5 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2"
