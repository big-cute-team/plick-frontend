 ...
 * description에는 축약명도 함께 넣어 두 표기 검색을 다 받는다. 이 URL이
 * canonical이고 대응 모바일 팀 허브를 alternate로 선언한다(KAN-346과 같은 규약).
 */
...
/**
 * 데스크톱 팀 허브 (KAN-350) — 팀 검색어를 받아줄 서버 렌더 URL. 홈 팀 필터는
 * 클라 상태라 구글이 도달할 수 없어서(SEO 전략 Step 2-2) 팀마다 고유 URL을
 * 만들었다.
 *
