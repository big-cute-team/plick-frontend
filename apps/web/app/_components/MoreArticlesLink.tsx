...
/**
 * 홈 → 기사 페이지 더보기 링크 (KAN-386, 모바일과 같은 판단). 홈 리스트가 첫
 * 페이지 고정이 되면서 나머지를 보러 가는 통로다. 섹션 제목 옆(header)과
 * 리스트 끝(footer) 두 자리에 놓이고, 목적지는 둘 다 지금 보고 있는 팀의 기사
 * 페이지다 — 위아래 링크가 서로 다른 곳으로 가면 헷갈린다.
 *
