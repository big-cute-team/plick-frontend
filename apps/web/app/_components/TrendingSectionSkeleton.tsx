 ...
 * fallback이다.
 *
 * 실제 카드와 같은 테두리·패딩에 제목 한 줄, 탭 두 개, 여섯 줄 자리를 깐다.
 * 사이드바는 sticky라 높이가 도착 전후로 달라지면 본문 옆에서 카드가 튄다.
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-1.5">
        <div className="bg-elevate rounded-pill h-6 w-12" />
        <div className="bg-elevate rounded-pill h-6 w-12" />
      </div>
      <div className="pt-1">
        {Array.from({ length: 6 }, (_, i) => (
          ...
          >
            ...
            <div className="bg-elevate size-6.5 shrink-0 rounded-full" />
