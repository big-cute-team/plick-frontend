...
export function GuestLinkCard({
  ...
  return (
    <Link
      href="/login"
      className="bg-elevate-2 border-border rounded-card gap-gap-lg hover:border-border-strong focus-visible:ring-accent flex w-full items-center border p-4.25 text-left transition-colors focus-visible:ring-2 focus-visible:outline-none"
    >
