...
/**
 * 로그아웃 버튼 + 확인 팝업 — 마이페이지의 로그아웃 상호작용을 담는 클라 경계 (KAN-318).
 * 모바일 `LogoutButton`과 같은 흐름이고 데스크톱이라 hover·focus 스타일만 얹는다.
 *
 * 버튼을 누르면 "정말 로그아웃할까요?" 팝업을 띄우고(오클릭 방지), 확인해야 로그아웃 서버 액션을
 ...
 * 로그인 상태로 받은 유저별 값(`likedByMe`)이 남을 수 있어, 로그인 경계에서 전부 비운다.
 */
