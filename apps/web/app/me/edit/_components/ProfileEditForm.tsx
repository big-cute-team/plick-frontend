...
/**
 * 프로필 수정 폼 (KAN-319, 모바일 이식) — 닉네임 입력과 응원팀 선택 상태를 들고,
 * "변경사항 저장"에서 프로필 저장 서버 액션을 부른다. 성공하면 액션이 MY로 보낸다.
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={submit}
        disabled={pending}
        className="bg-accent text-on-accent rounded-pill text-body-lg focus-visible:outline-accent flex h-13 w-full items-center justify-center font-extrabold transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 active:opacity-80 disabled:opacity-40"
      >
