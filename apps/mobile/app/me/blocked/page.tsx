...
/**
 * 차단 목록. MY의 "차단 목록" 행 진입 (KAN-411, KAN-567 리디자인). 목록은
 * `GET /users/me/blocks`로 읽고(페이지네이션 없는 배열, 최근 차단순),
 * 줄마다 차단 해제 텍스트 버튼을 단다. 해제 반영은 `BlockedUserList`가 로컬로 한다.
 */
export default async function BlockedUsersPage() {
  ...
  return (
    <AppShell>
      <SubTopBar title="차단 목록" backHref="/me" />

      <ScrollArea>
        <div className="px-edge pb-8">
