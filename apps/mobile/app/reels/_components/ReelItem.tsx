...
export function ReelItem({
  ...
  const handleOpen = () => {
    ...
    /* 도킹 지점: 시트 상단 라인에서 SHEET_TITLE_GAP만큼 위 */
    const sheetTop = s.bottom - s.height * SHEET_HEIGHT_RATIO;
    onOpenDetail(
      sheetTop - SHEET_TITLE_GAP - title.getBoundingClientRect().bottom,
    );
  };
