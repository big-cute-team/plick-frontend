...
export function MoreArticlesLink({
  ...
  if (variant === "header") {
    return (
      <Link
        href={href}
        className="text-label text-accent flex items-center font-bold active:opacity-60"
      >
        더보기
  ...
  return (
    <Link
      href={href}
      className="bg-elevate text-label text-accent rounded-control mt-2 flex items-center justify-center gap-0.5 py-3 font-bold active:opacity-70"
    >
