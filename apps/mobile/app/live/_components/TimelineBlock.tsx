...
/** 이벤트 종류 칩의 라벨·색 — VAR·교체는 info, 경고는 warn, 골은 accent. */
...
/**
 * 요약 탭의 타임라인 카드(피그마 L6) — 최신 이벤트가 위로 온다.
 * `playerName`이 null인 행(VAR 판정 등)은 부가 설명을 본문 자리로 올려
 * 이름 없이도 깨지지 않게 그린다(명세 함정 대응).
 */
