 ...
 * 들어왔을 때 순위표로 돌려보낸다. 글자는 시안(KAN-567)의 제목 900, 보조 text-3 톤이다.
 */
    ...
    <AppShell>
      <main className="px-edge flex h-full flex-col items-center justify-center gap-7">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-headline text-text-strong font-black">
            찾을 수 없는 팀이에요
          </h1>
        ...
        <Link href="/" className="text-body text-text-4 font-bold underline">
          홈으로 갈래요
        </Link>
      </main>
    </AppShell>
