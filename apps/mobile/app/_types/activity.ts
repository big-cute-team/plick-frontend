/**
 * @file 마이페이지 활동 화면 타입 (KAN-495). 첫 사용처가 모바일뿐이라 앱 레이어에
...
/** 활동 화면의 탭. URL `?tab=`의 값이자 쿼리키의 스코프다. */
export type ActivityTab = "likes" | "comments";
...
export interface MyComment {
  ...
  isBlinded: boolean;
  likeCount: number;
  /** 댓글이 달린 기사. 눌러서 들어갈 곳이자 썸네일·제목의 출처. */
  article: {
