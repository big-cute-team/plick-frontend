...
/**
 * VS 탭 — V·S 레터폼 (KAN-435). 토론이 VS로 리브랜딩되면서 말풍선(DebateIcon)을
 * 대체했다. 피그마 시안 없이 하단 탭 세트의 기하(24 그리드·1.8 스트로크)에 맞춰
 * 직접 그렸다 — LiveIcon과 같은 경위다.
 */
export const VsIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M3.2 8l3.6 8.4L10.4 8" />
    <path d="M20.6 9.3c-.5-1-1.6-1.7-3-1.7-1.8 0-3.1 1-3.1 2.3 0 3 6.4 1.6 6.4 4.6 0 1.4-1.4 2.3-3.2 2.3-1.5 0-2.7-.7-3.2-1.7" />
  </svg>
);
