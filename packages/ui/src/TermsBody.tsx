 ...
 * 탈퇴 후 7일 재가입 제한은 KAN-393에서 생겨 9조에 반영했다.
  ...
  return (
    <div className="text-body text-text-2 flex flex-col gap-6 leading-relaxed">
      ...
      <Section id="definitions" title="제2조 (정의)">
        <ol className="flex list-decimal flex-col gap-1.5 pl-5">
          ...
          <li>
            ...
            로그인(카카오·구글·애플)으로 가입하여 서비스를 이용하는 자를
            말합니다.
          </li>
          <li>
      ...
      <Section id="signup" title="제4조 (이용계약의 체결)">
        <ol className="flex list-decimal flex-col gap-1.5 pl-5">
          <li>
            이용계약은 가입 희망자가 이 약관에 동의하고 카카오, 구글 또는 애플
            소셜 로그인으로 가입을 신청하면, 운영자가 이를 승낙함으로써
            체결됩니다.
          </li>
          <li>
            서비스는 14세 미만 아동을 이용 대상으로 하지 않습니다. 가입은 14세
            미만의 단독 가입을 제한하는 카카오·구글·애플 계정으로만 가능합니다.
          </li>
          <li>
      ...
      <Section id="termination" title="제9조 (계약 해지 및 이용 제한)">
        <ol className="flex list-decimal flex-col gap-1.5 pl-5">
          ...
          <li>
            부정이용(탈퇴와 재가입의 반복을 통한 제재 회피 등) 방지를 위해,
            탈퇴한 소셜 계정으로는 탈퇴 후 7일이 지나야 다시 가입할 수 있습니다.
            7일이 지나 같은 소셜 계정으로 다시 가입하면 신규 가입으로 처리되며,
            이전 활동과 연결되지 않습니다.
          </li>
          <li>
      ...
      <Section id="addendum" title="부칙">
        <p>
          이 약관은 2026. 8. 31.부터 시행합니다. (직전 버전은 2026. 8. 19.부터
          시행되었으며, 이번 개정으로 애플 소셜 로그인 도입에 따라 가입 수단에
          애플 계정을 제2조·제4조에 추가했습니다.)
        </p>
      </Section>
    </div>
  );
