 ...
 * 것은 댓글뿐이라 7·8조를 댓글 기준으로 썼다. 앱 내 탈퇴는 KAN-391에서 생겨
 * 7·9조에 반영했다(댓글은 탈퇴한사용자로 유지, 탈퇴 후 수정·삭제 불가).
 * 회원 작성 콘텐츠가 늘거나 유료 기능·제재 절차가 생기면 이 문서도 같은 PR에서
 * 개정한다. 개인정보 항목이 바뀌면 `PrivacyPolicyBody`와 함께 고친다.
 */
    ...
    <div className="text-body text-text-2 flex flex-col gap-6 leading-relaxed">
      ...
      <Section id="comments" title="제7조 (회원이 작성한 댓글)">
        <ol className="flex list-decimal flex-col gap-1.5 pl-5">
          ...
          <li>
            회원이 탈퇴하더라도 작성한 댓글은 삭제되지 않고 작성자가
            &ldquo;탈퇴한사용자&rdquo;로 표시된 채 유지됩니다. 탈퇴 후에는
            댓글을 수정하거나 삭제할 수 없으므로, 남기고 싶지 않은 댓글은 탈퇴
            전에 직접 삭제해야 합니다.
          </li>
          <li>
      ...
      <Section id="termination" title="제9조 (계약 해지 및 이용 제한)">
        <ol className="flex list-decimal flex-col gap-1.5 pl-5">
          <li>
            회원은 언제든지 서비스 내 MY 화면의 탈퇴하기 기능으로 이용계약을
            해지(탈퇴)할 수 있습니다. 탈퇴는 즉시 처리되며, 탈퇴한 계정은 복구할
            수 없습니다.
          </li>
          <li>
            탈퇴 시 개인정보는 개인정보 처리방침에 따라 파기(삭제 또는
            익명처리)됩니다. 작성한 댓글은 제7조에 따라 탈퇴한사용자 표시로
            유지됩니다. 탈퇴 후 같은 소셜 계정으로 다시 가입하면 신규 가입으로
            처리되며, 이전 활동과 연결되지 않습니다.
          </li>
          <li>
      ...
      <Section id="addendum" title="부칙">
        <p>
          이 약관은 2026. 8. 13.부터 시행합니다. (직전 버전은 2026. 8. 5.부터
          시행되었으며, 이번 개정으로 앱 내 회원탈퇴 절차와 탈퇴 시 댓글 처리
          기준을 제7조·제9조에 반영했습니다.)
        </p>
      </Section>
    </div>
