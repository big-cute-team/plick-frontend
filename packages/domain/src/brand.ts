 ...
 * 원래 구글 권장 길이(80~160자)로 길게 썼는데(KAN-384), 네이버 서치어드바이저가
 * 설명문을 80자 이내로 권장하고 초과분을 잘라내서 80자 경계에 맞췄다(KAN-386).
 * meta description과 og:description(명시 없으면 이 값을 물려받는다) 둘 다
 * 이 상수 하나다.
 */
 ...
 * 네이버 권장에 맞춰 80자 이내로 유지한다(KAN-386).
 */
export const PAGE_DESCRIPTIONS = {
  reels:
    "프리미어리그 이적 루머와 소식을 짧은 릴스로 넘겨보세요. 리버풀부터 맨시티까지 EPL 이적시장 소식을 스와이프로 빠르게 확인하세요.",
  articles:
    "프리미어리그 이적 기사 모아보기. 리버풀, 토트넘, 아스날, 맨유, 첼시, 맨시티 등 팀별 이적 루머와 오피셜 소식을 최신순으로 확인하세요.",
  debates:
    "프리미어리그 이적 루머 투표. 지금 뜨거운 이적 토론에 투표하고 팬들의 여론을 확인하세요.",
  login:
